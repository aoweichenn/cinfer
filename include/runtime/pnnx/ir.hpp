...
namespace pnnx
{
    ...
    public:
        ...
        explicit Parameter(const std::string&  _string): type(4), string(_string){}
        ...
        Parameter(const std::initializer_list<std::complex<float>>& _complex_float_array):type(11),complex_float_array(_complex_float_array){}
        explicit Parameter(const std::vector<std::complex<float>>& _complex_float_array):type(11),complex_float_array(_complex_float_array){}
